...
const CosmosChainsTable = ({config, loadConfigDetails, pageChanger,
  ...
  removeKmsDetails, removeOpsGenieDetails, removePagerDutyDetails,
  removeEmailDetails, removeTwilioDetails, removeTelegramDetails, telegrams,
  twilios, emails, pagerduties, opsgenies }) => {
