...
export const UPDATE_WARNING_DELAY = 'UPDATE_WARNING_DELAY';
export const UPDATE_WARNING_REPEAT = 'UPDATE_WARNING_REPEAT';
export const UPDATE_WARNING_THRESHOLD = 'UPDATE_WARNING_THRESHOLD';
export const UPDATE_WARNING_TIMEWINDOW = 'UPDATE_WARNING_TIMEWINDOW';
export const UPDATE_WARNING_ENABLED = 'UPDATE_WARNING_ENABLED';
export const UPDATE_CRITICAL_DELAY = 'UPDATE_CRITICAL_DELAY';
export const UPDATE_CRITICAL_REPEAT = 'UPDATE_CRITICAL_REPEAT';
export const UPDATE_CRITICAL_THRESHOLD = 'UPDATE_CRITICAL_THRESHOLD';
export const UPDATE_CRITICAL_TIMEWINDOW = 'UPDATE_CRITICAL_TIMEWINDOW';
export const UPDATE_CRITICAL_ENABLED = 'UPDATE_CRITICAL_ENABLED';
export const UPDATE_ALERT_ENABLED = 'UPDATE_ALERT_ENABLED';

// Alerts with severties related actions
export const UPDATE_ALERT_SEVERTY_LEVEL = 'UPDATE_ALERT_SEVERTY_LEVEL';
export const UPDATE_ALERT_SEVERTY_ENABLED = 'UPDATE_ALERT_SEVERTY_ENABLED';
