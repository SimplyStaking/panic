      ...
      <Host>
        <svc-footer color="primary" headline-position="start" headline="Developed by SimplyVC">
          <svc-buttons-container position="end">
            <svc-button icon-name="logo-twitter" href={this._twitterURL} target="_blank"></svc-button>
            <svc-button icon-name="logo-github" href={this._githubURL} target="_blank"></svc-button>
            <svc-button icon-name="logo-medium" href={this._mediumURL} target="_blank"></svc-button>
            <svc-button icon-src={getAssetPath(`./assets/${this._telegramLogoSVG}`)} href={this._telegramURL} target="_blank"></svc-button>
            <svc-button icon-src={getAssetPath(`./assets/${this._simplyVcLogoSVG}`)} href={this._websiteURL} target="_blank"></svc-button>
