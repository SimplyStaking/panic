...
function getDataTableJSX(alerts: Alert[]): JSX.Element {
    ...
    const rows: DataTableRowsType = hasAlerts ? getDataTableRowsTypeFromAlerts(alerts) : [];
...
/**
 * Gets {@link DataTableRowsType} from an array of alerts.
 * @param alerts array of alerts.
 * @returns populated {@link DataTableRowsType} object.
 */
function getDataTableRowsTypeFromAlerts(alerts: Alert[]): DataTableRowsType {
...
/**
 * Formats the event data generated by the svc-event-emitter/svc-select components.
