...
from src.utils.constants.rabbitmq import (
    HEALTH_CHECK_EXCHANGE, TOPIC, SUBSTRATE_ALERTERS_MAN_HB_QUEUE_NAME,
    PING_ROUTING_KEY, CONFIG_EXCHANGE, SUBSTRATE_NODE_ALERT_ROUTING_KEY,
    SUBSTRATE_ALERTERS_MAN_CONFIGS_QUEUE_NAME,
    SUBSTRATE_ALERTS_CONFIGS_ROUTING_KEY,
    ALERT_EXCHANGE, SUBSTRATE_NETWORK_ALERT_ROUTING_KEY)
from src.utils.exceptions import MessageWasNotDeliveredException
from src.utils.logging import log_and_print


class SubstrateAlertersManager(AlertersManager):
    def __init__(self, logger: logging.Logger, manager_name: str,
                 rabbitmq: RabbitMQApi) -> None:
        super().__init__(logger, manager_name, rabbitmq)
        self._node_alerts_config_factory = (
        ...
        self._configs_processor_helper = {
            SUBSTRATE_NODE_ALERTER_NAME: {
                ...
                'configsClass': SubstrateNodeAlertsConfig,
            ...
            SUBSTRATE_NETWORK_ALERTER_NAME: {
                ...
                'configsClass': SubstrateNetworkAlertsConfig,
    ...
    @property
    def node_alerts_config_factory(self) -> SubstrateNodeAlertsConfigsFactory:
        return self._node_alerts_config_factory

    @property
    def network_alerts_config_factory(
            self) -> SubstrateNetworkAlertsConfigsFactory:
    ...
    def _initialise_rabbitmq(self) -> None:
        ...
        self.logger.info("Binding queue '%s' to exchange '%s' with routing key "
                         "'%s'", SUBSTRATE_ALERTERS_MAN_HB_QUEUE_NAME,
                         HEALTH_CHECK_EXCHANGE, PING_ROUTING_KEY)
        self.rabbitmq.queue_bind(SUBSTRATE_ALERTERS_MAN_HB_QUEUE_NAME,
                                 HEALTH_CHECK_EXCHANGE, PING_ROUTING_KEY)
        self.logger.info("Declaring consuming intentions on '%s'",
                         SUBSTRATE_ALERTERS_MAN_HB_QUEUE_NAME)
        self.rabbitmq.basic_consume(SUBSTRATE_ALERTERS_MAN_HB_QUEUE_NAME,
        ...
        self.rabbitmq.queue_declare(
            ...
            False)
        self.logger.info("Binding queue '%s' to exchange '%s' with routing key "
                         "%s'", SUBSTRATE_ALERTERS_MAN_CONFIGS_QUEUE_NAME,
        ...
        self.logger.info("Declaring consuming intentions on %s",
                         SUBSTRATE_ALERTERS_MAN_CONFIGS_QUEUE_NAME)
        self.rabbitmq.basic_consume(SUBSTRATE_ALERTERS_MAN_CONFIGS_QUEUE_NAME,
    ...
    def _create_and_start_alerter_processes(self) -> None:
        """
        Start the Substrate Alerters in a separate process if they are not yet
    ...
    def _on_terminate(self, signum: int, stack: FrameType) -> None:
        log_and_print(
            ...
            "the Substrate alerters will be stopped gracefully. Afterwards the "
