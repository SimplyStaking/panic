...
from src.alerter.alert_metric_code import AlertMetricCode
...
class Alert:
    ...
    def __init__(self, alert_code: AlertCode, message: str, severity: str,
                 ...
                 alert_metric_code: AlertMetricCode) -> None:
        ...
        self._alert_metric_code = alert_metric_code
    ...
    @property
    def alert_metric_code(self) -> AlertMetricCode:
        return self._alert_metric_code
    ...
    def alert_data(self) -> Dict:
        return {
            ...
            'metric': self._alert_metric_code.value,
