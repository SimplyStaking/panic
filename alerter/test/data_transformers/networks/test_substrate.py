...
from test.test_utils.utils import (
    ...
    disconnect_from_rabbit, save_substrate_network_to_redis)


class TestSubstrateNetworkTransformer(unittest.TestCase):
    def setUp(self) -> None:
        # Some dummy data
        self.test_data_str = 'test_data'
        self.transformer_name = 'test_substrate_network_data_transformer'
        ...
        self.test_active_proposal_alerting_1 = {
            'index': self.test_proposal_index_1,
            'balance': self.test_proposal_balance_1,
            'image': self.test_proposal_image_1,
            'imageHash': self.test_proposal_imageHash_1,
        ...
        self.test_active_proposal_alerting_2 = {
            'index': self.test_proposal_index_2,
            'balance': self.test_proposal_balance_2,
            'image': self.test_proposal_image_2,
            'imageHash': self.test_proposal_imageHash_2,
        ...
        self.test_active_proposals_alerting = [
            self.test_active_proposal_alerting_1,
            self.test_active_proposal_alerting_2,
        ]
        ...
        self.test_referendum_data_alerting_2 = copy.deepcopy(
            self.test_referendum_data_2)
        del self.test_referendum_data_alerting_2['votes']

        self.test_referendum_alerting_2 = {
            'index': self.test_referendum_index_2,
            'status': self.test_referendum_status_2,
            'approved': self.test_referendum_approved_2,
            'end': self.test_referendum_end_2,
            'data': self.test_referendum_data_alerting_2
        }

        self.test_referendums_alerting = [
            self.test_referendum_1,
            self.test_referendum_alerting_2
        ]
        ...
        self.test_raw_data = {
            ...
            'active_referendums': [
                {
                    ...
                    "imageHash": self.test_referendum_proposalHash,
                    "index": "0x00000001",
                    "status": {
                        "end": 7257600,
                    ...
                    "allAye": [
                        {
                            "accountId": self.test_account_1,
                            "isDelegating":
                                self.test_referendum_vote_isDelegating_1,
                            "registry": {},
                            "vote": "0x80",
                            "balance": "0x00000000000000000000007B"
                        },
                    ],
                    "allNay": [
                        {
                            "accountId": self.test_account_3,
                            "isDelegating":
                                self.test_referendum_vote_isDelegating_2,
                            "registry": {},
                            "vote": "0x00",
                            "balance": "0x00000000000000000000007B"
                        },
            ...
            'all_referendums': {
                str(self.test_referendum_index_1): {
                    "finished": {
                        "approved": self.test_referendum_approved_1,
                        "end": self.test_referendum_end_1
                    }
                },
                str(self.test_referendum_index_2): {
                    "ongoing": {
                        "end": self.test_referendum_end_2,
                        "proposalHash": self.test_referendum_proposalHash,
                        "threshold": self.test_referendum_threshold,
        ...
        # Test network
        self.network_1 = SubstrateNetwork('parent_id_1', 'chain_name_1')
        self.test_state = {self.network_1.parent_id: self.network_1}
        self.network_1.set_grandpa_stalled(self.test_grandpa_stalled)
        self.network_1.set_public_prop_count(self.test_public_prop_count)
        self.network_1.set_active_proposals(self.test_active_proposals)
        self.network_1.set_referendum_count(self.test_referendum_count)
        self.network_1.set_referendums(self.test_referendums)
        self.network_1.set_last_monitored_websocket(self.test_last_monitored)
        ...
        self.raw_data_example_result_options_None = copy.deepcopy(
            self.raw_data_example_result_all)
        self.raw_data_example_result_options_None['websocket']['result'][
            'data']['active_proposals'] = []
        self.raw_data_example_result_options_None['websocket']['result'][
            'data']['active_referendums'] = []
        self.raw_data_example_result_options_None['websocket']['result'][
            'data']['all_referendums'] = {}
        ...
        self.transformed_data_example_result_options_None = copy.deepcopy(
            self.transformed_data_example_result_all)
        self.transformed_data_example_result_options_None['websocket'][
            'result']['data']['active_proposals'] = []
        self.transformed_data_example_result_options_None['websocket'][
            'result']['data']['referendums'] = []
        ...
        self.processed_data_example_result_all = {
            'websocket': {
                'result': {
                    ...
                    'data': {
                        'grandpa_stalled': {
                            'current': self.test_grandpa_stalled,
                            'previous': None,
                        },
                        'public_prop_count': {
                            'current': self.test_public_prop_count,
                            'previous': None,
                        },
                        'active_proposals': {
                            'current': self.test_active_proposals_alerting,
                            'previous': [],
                        },
                        'referendum_count': {
                            'current': self.test_referendum_count,
                            'previous': None,
                        },
                        'referendums': {
                            'current': self.test_referendums_alerting,
                            'previous': [],
                        },
                    },
                }
        ...
        self.processed_data_example_result_options_None = copy.deepcopy(
            self.processed_data_example_result_all)
        self.processed_data_example_result_options_None['websocket'][
            'result']['data']['active_proposals']['current'] = []
        self.processed_data_example_result_options_None['websocket'][
            'result']['data']['referendums']['current'] = []
        ...
        # Test transformer
        self.test_network_transformer = SubstrateNetworkTransformer(
    ...
    def test_load_state_successful_if_network_exists_in_redis_and_redis_online(
        ...
        save_substrate_network_to_redis(self.redis, self.network_1)
        expected_loaded_network = copy.deepcopy(self.network_1)

        # Reset websocket network to default values to detect the loading
        self.network_1.reset()

        # Load state
        loaded_substrate_network = self.test_network_transformer.load_state(
            self.network_1)
        self.assertEqual(expected_loaded_network, loaded_substrate_network)
        ...
        save_substrate_network_to_redis(self.redis, default_data_network)

        self.network_1.reset()
        loaded_substrate_network = self.test_network_transformer.load_state(
            self.network_1)
        self.assertEqual(default_data_network, loaded_substrate_network)
    ...
    def test_load_state_keeps_same_state_if_network_in_redis_and_redis_offline(
        ...
        # Reset substrate network to default values to check that the state
        # was not loaded
        self.network_1.reset()
    ...
    @mock.patch.object(SubstrateNetworkTransformer,
                       "_process_transformed_data_for_alerting")
    @mock.patch.object(SubstrateNetworkTransformer,
    ...
    @mock.patch.object(SubstrateNetworkTransformer, "_transform_data")
    ...
    @mock.patch.object(SubstrateNetworkTransformer, "_update_state")
    @mock.patch.object(RabbitMQApi, "basic_ack")
    ...
    @mock.patch.object(SubstrateNetworkTransformer, "_send_data")
    @mock.patch.object(SubstrateNetworkTransformer,
                       "_place_latest_data_on_queue")
    @mock.patch.object(SubstrateNetworkTransformer, "_update_state")
    @mock.patch.object(RabbitMQApi, "basic_ack")
    ...
    @mock.patch.object(SubstrateNetworkTransformer, "_send_heartbeat")
    @mock.patch.object(SubstrateNetworkTransformer, "_send_data")
    @mock.patch.object(SubstrateNetworkTransformer,
                       "_place_latest_data_on_queue")
    @mock.patch.object(SubstrateNetworkTransformer, "_update_state")
