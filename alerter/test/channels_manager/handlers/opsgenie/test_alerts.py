...
class TestOpsgenieAlertsHandler(unittest.TestCase):
    ...
    def test_opsgenie_channel_returns_associated_opsgenie_channel(self) -> None:
    ...
    def test_place_alert_on_queue_places_alert_on_queue_if_queue_not_full(
        ...
        self.test_opsgenie_alerts_handler._place_alert_on_queue(self.test_alert)
    ...
    def test_send_alerts_stops_sending_if_an_alert_is_not_successfully_sent(
        ...
        self.assertFalse(self.test_opsgenie_alerts_handler.alerts_queue.empty())
        self.assertEqual(2,
                         self.test_opsgenie_alerts_handler.alerts_queue.qsize())
        self.assertEqual(
            test_alert_1,
