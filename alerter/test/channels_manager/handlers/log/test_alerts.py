...
class TestLogAlertsHandler(unittest.TestCase):
    ...
    def test_initialise_rabbitmq_initialises_rabbit_correctly(
        ...
        try:
            ...
            # called successfully.
            self.assertTrue(
                self.test_log_alerts_handler.rabbitmq.is_connected)
            self.assertTrue(
                self.test_log_alerts_handler.rabbitmq.connection.is_open)
            self.assertTrue(
                self.test_log_alerts_handler.rabbitmq.channel
    ...
    def test_process_alert_sends_alert_to_the_logs_if_no_processing_errors(
        ...
        try:
            ...
            # Send alert
            self.test_log_alerts_handler._process_alert(blocking_channel,
                                                        method, properties,
                                                        body)
