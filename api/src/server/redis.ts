...
export const getChainlinkKeys = (): ChainlinkNodeKeys => ({
    ...
    no_of_active_jobs: 'c3',
    max_pending_tx_delay: 'c4',
    process_start_time_seconds: 'c5',
    total_gas_bumps: 'c6',
    total_gas_bumps_exceeds_limit: 'c7',
    no_of_unconfirmed_txs: 'c8',
    total_errored_job_runs: 'c9',
    current_gas_price_info: 'c10',
    eth_balance_info: 'c11',
    went_down_at_prometheus: 'c12',
    last_prometheus_source_used: 'c13',
    last_monitored_prometheus: 'c14',
});
