...
/**
 * Builder to create Mongoose Schema and Model of Opsgenie Entity
 */
export class OpsgenieModelBuilder implements IModelBuilder<OpsgenieChannel> {

    private _schema: Schema = null;
    private _model: Model<OpsgenieChannel> = null;

    public produceSchema(): void {

        const entity = {} as OpsgenieChannel;
    ...
    public produceModel(): void {
        this._model = mongoose.model(
            ...
            this._schema,
            Collection.CONFIG
        ) as Model<OpsgenieChannel>;
    }

    public get model(): Model<OpsgenieChannel> {
        return this._model;
    }
